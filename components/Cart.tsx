...
export const Cart: FC = () => {
  ...
  return (
    <div className="fixed top-24 z-10 ml-4 md:top-20 md:ml-20">
      <button
      ...
      <div className="inline-block h-10 w-10 rounded-[50%] bg-red p-2 text-center text-white">
        {itemCount}
      </div>
      {isCartVisible && itemCount > 0 && (
        <ul className="absolute top-10 z-10 grid w-40 gap-4 rounded-md bg-white p-4 shadow-card">
          {cartItems.map((item) => (
